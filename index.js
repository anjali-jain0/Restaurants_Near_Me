...
app.get('/avail2/:id/:number',function(req,res){

	app.locals.seat="2 Seater";
	var query={_id:req.params.id};
	Citywise.update(query,{twoseat:req.params.number-1},function(err){
		if(err) throw err;
...
app.get('/avail4/:id/:number',function(req,res){

    app.locals.seat="4 Seater";
	var query={_id:req.params.id};
	Citywise.update(query,{fourseat:req.params.number-1},function(err){
		if(err) throw err;
...
app.get('/avail6/:id/:number',function(req,res){
    
    app.locals.seat="6 Seater";
	var query={_id:req.params.id};
	Citywise.update(query,{sixseat:req.params.number-1},function(err){
		if(err) throw err;
...
app.get('/side',urlencodedParser,function(req,res){
	res.sendFile(path.join(__dirname + '/html/cuisine5.html'));
});
